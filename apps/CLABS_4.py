...
import sys
import time
from CLABS_4_init import CLABS_4_init
import socket
import threading
import select
import Queue
...
if __name__ == '__main__':
    ...
    tb = CLABS_4_init(initial_txgain=options.txgain, rxfreq=options.rxfreq, samp_rate=options.samp_rate, initial_rxgain=options.rxgain, txfreq=options.txfreq, initial_baseband_gain=options.baseband_gain)
